...
As of 3/8/20, there is discussion of how _ThunderboltDROM_ and _ThunderboltConfig_ seem to significant affect TB performance. In adjusting the SSDT files, the built-in TB seems to respond well to this injection (SSP1 and SSP2 are assigned to ports 3 and 4, respectively; see image below). SSP1 and SSP2 appear with or without a USB-C drive connected.
